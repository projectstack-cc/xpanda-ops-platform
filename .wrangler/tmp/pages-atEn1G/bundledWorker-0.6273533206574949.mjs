...
var API_ROUTES = [
  // Admin
  { prefix: "/api/users", handler: /* @__PURE__ */ __name((req, env) => handleApiUsers(req, env), "handler") },
  { prefix: "/api/roles", handler: /* @__PURE__ */ __name((req, env) => handleApiRoles(req, env), "handler") },
  // QC
  { path: "/api/completions", handler: /* @__PURE__ */ __name((req, env) => handleApiCompletions(req, env), "handler") },
  { path: "/api/scrap-log", handler: /* @__PURE__ */ __name((req, env) => handleApiScrapLog(req, env), "handler") },
  // Reports (scrap)
  { path: "/api/reports/scrap-summary", handler: /* @__PURE__ */ __name((req, env) => handleApiReportsScrapSummary(req, env), "handler") },
  { path: "/api/reports/scrap-trend", handler: /* @__PURE__ */ __name((req, env) => handleApiReportsScrapTrend(req, env), "handler") },
  { path: "/api/reports/scrap-reasons", handler: /* @__PURE__ */ __name((req, env) => handleApiReportsScrapReasons(req, env), "handler") },
  // Reports (incidents)
  { path: "/api/reports/incidents-trend", handler: /* @__PURE__ */ __name((req, env) => handleIncidentTrend(req, env), "handler") },
  { path: "/api/reports/incidents-summary", handler: /* @__PURE__ */ __name((req, env) => handleIncidentSummary(req, env), "handler") },
  { path: "/api/reports/incidents-list", handler: /* @__PURE__ */ __name((req, env) => handleIncidentList(req, env), "handler") },
  { path: "/api/reports/incidents-detail", handler: /* @__PURE__ */ __name((req, env) => handleIncidentDetail(req, env), "handler") },
  // Parts / production
  { path: "/api/parts", handler: /* @__PURE__ */ __name((req, env) => handleApiParts(req, env), "handler") },
  { path: "/api/combos", handler: /* @__PURE__ */ __name((req, env) => handleApiCombos(req, env), "handler") },
  { path: "/api/bead-types", handler: /* @__PURE__ */ __name((req, env) => handleApiBeadTypes(req, env), "handler") },
  { path: "/api/bead-stock", handler: /* @__PURE__ */ __name((req, env) => handleApiBeadStock(req, env), "handler") },
  { path: "/api/block-inventory", handler: /* @__PURE__ */ __name((req, env) => handleApiBlockInventory(req, env), "handler") },
  { path: "/api/molding-log", handler: /* @__PURE__ */ __name((req, env) => handleApiMoldingLog(req, env), "handler") },
  { path: "/api/block-consumption", handler: /* @__PURE__ */ __name((req, env) => handleApiBlockConsumption(req, env), "handler") },
  // Jobs / shipments
  { prefix: "/api/jobs", handler: /* @__PURE__ */ __name((req, env) => handleApiJobs(req, env), "handler") },
  { path: "/api/shipments", handler: /* @__PURE__ */ __name((req, env) => handleApiShipments(req, env), "handler") },
  // BOL / load builder (specific paths before their shared prefixes)
  { path: "/api/bol-customers/seed", handler: /* @__PURE__ */ __name((req, env) => handleApiBolCustomersSeed(req, env), "handler") },
  { path: "/api/bol-customers", handler: /* @__PURE__ */ __name((req, env) => handleApiBolCustomers(req, env), "handler") },
  { path: "/api/bol-carriers", handler: /* @__PURE__ */ __name((req, env) => handleApiBolCarriers(req, env), "handler") },
  { prefix: "/api/bols", handler: /* @__PURE__ */ __name((req, env) => handleApiBols(req, env), "handler") },
  { path: "/api/load-builder-skus/seed", handler: /* @__PURE__ */ __name((req, env) => handleApiPartsSeed(req, env), "handler") },
  { path: "/api/load-builder-skus/all", handler: /* @__PURE__ */ __name((req, env) => handleApiLoadBuilderSkusDeleteAll(req, env), "handler") },
  { prefix: "/api/load-builder-skus", handler: /* @__PURE__ */ __name((req, env) => handleApiLoadBuilderSkus(req, env), "handler") },
  { prefix: "/api/saved-loads", handler: /* @__PURE__ */ __name((req, env) => handleApiSavedLoads(req, env), "handler") },
  // Loading
  { prefix: "/api/loading-bays", handler: /* @__PURE__ */ __name((req, env) => handleApiLoadingBays(req, env), "handler") },
  { prefix: "/api/loading-assignments", handler: /* @__PURE__ */ __name((req, env) => handleApiLoadingAssignments(req, env), "handler") },
  { prefix: "/api/loading-photos", handler: /* @__PURE__ */ __name((req, env) => handleApiLoadingPhotos(req, env), "handler") },
  // Platform
  { prefix: "/api/activity-log", handler: /* @__PURE__ */ __name((req, env) => handleApiActivityLog(req, env), "handler") },
...
//# sourceMappingURL=bundledWorker-0.6273533206574949.mjs.map
