...
- [ ] lb-engine-04 — legacy comparison harness: a read-only, frozen port of legacy `calcLoading` into a test fixture for regression comparison against the new engine. Never a modification of `logistics/load-builder.html`.
